...
static CBlock CreateGenesisBlockBitcoin(uint32_t nTime, uint32_t nNonce, uint32_t nBits, int32_t nVersion, const CAmount& genesisReward)
{
...
class CMainParamsBitcoin : public CChainParams {
public:
    CMainParamsBitcoin() {
        strNetworkID = "main";
...
public:
    CTestNetParams() {
        ...
        genesis = CreateGenesisBlockBitcoin(1296688602, 414098458, 0x1d00ffff, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
...
public:
    explicit CRegTestParams(const ArgsManager& args) {
        ...
        genesis = CreateGenesisBlockBitcoin(1296688602, 2, 0x207fffff, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
